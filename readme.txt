...
Tags: social media share buttons, Google Analytics, acquisition reports, link tracking, Custom Google Campaign
Tested up to: 6.6
Stable tag: 4.0.0
...
Facebook, X (formerly Twitter), LinkedIn, Pinterest, email, and copying to clipboard (for sites with SSL enabled) are supported.
...
= 4.0.0 =
Code overhaul for better practices, performance, and usability!
